...
import { Badge, Card, Group, Image, Text, useMantineColorScheme } from '@mantine/core';
  ...
  return (
    ...
    >
      <Group justify="space-between" align="flex-start" gap="md">
        ...
        <div style={{ flex: 1 }}>
          <Text size="lg" fw={600} c={variantStyles.text} mb={4}>
            {phone}
          </Text>
          <Text size="md" c={variantStyles.secondaryText} mb={8}>
            {service}
          </Text>
        ...
        <Button onClick={onClick} size="md" style={{ flexShrink: 0 }}>
          Написать
        </Button>
      </Group>
    </Card>
