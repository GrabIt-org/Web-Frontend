...
export const mockRentAd: IRentalDetail[] = [
  ...
  },
  {
    ...
    description:
      'Мощный перфоратор Bosch GBH 2-26 DRE. Идеален для сверления бетона, кирпича, камня. Быстрозажимной патрон, реверс, регулировка оборотов. В комплекте: чемодан, набор буров, долото, смазка.',
    ...
    media: [
      ...
      {
        id: 4,
        url: 'https://avatars.mds.yandex.net/get-marketpic/6097806/pic7f3c9b3d4c2a2d6c9f5d9b4c1d2e4f4/orig',
      },
    ],
    renter: {
      id: 3,
