...
import { mockRentItems } from '@modules/rentals/constants/mockRentItems.ts';

import { RentalsCategories } from '../components/RentalsCategories';
  ...
  const filteredItems = useMemo(() => {
    ...
    if (sortValue) {
      switch (sortValue) {
        ...
        case 'price_asc':
          items = [...items].sort(
            (a, b) => a.cost.payment - b.cost.payment,
          );
          break;

        case 'price_desc':
          items = [...items].sort(
            (a, b) => b.cost.payment - a.cost.payment,
          );
          break;
